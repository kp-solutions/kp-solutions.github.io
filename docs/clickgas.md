...
# App Click Gás - Política de Privacidade

Esta política de privacidade descreve como o App **Click Gás** coleta, usa, compartilha e protege suas informações quando você utiliza nosso aplicativo disponível na Google Play Store.

## Informações que Coletamos

Ao utilizar o App Click Gás, coletamos as seguintes informações:
...
O App Click Gás solicita as seguintes permissões:
...
* **Notificação**: Para informar o usuário de promoções e atualização de status de um pedido.
...
O App Click Gás não é destinado a menores de 18 anos e não coletamos intencionalmente informações de crianças.
